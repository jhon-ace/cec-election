...
<head>
    ...
    <title>Grade - 11 | List of Voters</title>
                        ...
                        <div class="col" style="margin-top: -80px">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <form method="POST">
                                        <h3 class="title" style="font-family: Fjalla One"><b>List of Grade 11 Voters</b><a href="../grade11/list_of_total_voters_grade11.php" class = "btn btn-info text-info" type='button' style="float: right;margin-top: 17px;margin-left: 5px" ><i class="fa fa-refresh"></i></a><a href="../grade11/students_grade11.php" class = "btn btn-info text-info" type='button' style="float: right;margin-top: 17px;" ><i class="fa fa-arrow-left fa-10x"></i> Back</a></h3>
                                    </form>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total Number: <b><a href=""><text id="totalgrade11" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>    
                                    </div>
                                    <div class="col">
                                         <b><a href="../fpdf/studentlistpdf_studentsgrade11.php" target="_blank"><i class="fa fa-print"></i> <text  style="text-decoration: underline;">&nbsp;Print List</text></a></b>    
                                    </div>
                                </div>
