...
<?php
    $db = mysqli_connect('localhost', 'root', '', 'election_final');
        ...
        <div class="main-panel">
            ...
            <div class="content">
                        ...
                        <div class="col" style="margin-top: -80px">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <form method="POST">
                                        <h3 class="title" style="font-family: Fjalla One"><b>Grade 11 Students</b><button class = "btn btn-info text-info" type='button' data-toggle="modal" data-target="#add_student_grade11" style="float: right;margin-left: 5px;margin-top: 17px;" ><i class="fa fa-user-plus fa-10x"></i></button><a href="students_grade11.php" class = "btn btn-info text-info" type='button' style="float: right;margin-top: 17px;" ><i class="fa fa-refresh fa-10x"></i></a></h3>
                                    </form>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total No: <b><a href="list_of_total_voters_grade11.php"><text id="totalgrade11" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                              
                                    </div>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total number of Successful Voters: <b><a href="list_of_finish_voters_grade11.php"><text id="successfulVotersgrade11" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                              
                                    </div>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Remaining number of voters: <b><a href="list_of_remaining_voters_grade11.php"><text id="remainingVotersgrade11" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                    ...
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Block voters: <b><a href="list_of_block_voters_grade11.php"><text id="blockvotersgrade11" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                ...
                <?php
                        ...
                        $link = mysqli_connect("localhost","root","","election_final");
   ...
   <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#totalgrade11").load('totalnograde11students.php')
          }, 200);
        });
    </script>
    ...
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#successfulVotersgrade11").load('getSuccessVotersgrade11.php')
          }, 200);
        });
    </script>
    ...
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#remainingVotersgrade11").load('getRemainingVotersgrade11.php')
          }, 200);
        });
    </script>
    ...
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#blockvotersgrade11").load('getblockVotersgrade11.php')
          }, 200);
        });
    </script>
