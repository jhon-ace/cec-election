...
<?php
    ...
    if(isset($_POST['submit-new-student-4th-year']))
    {
                ...
                if (mysqli_num_rows($res_u) > 0) 
                {
                    $message = "Student ID Exist";
                        echo "<script type='text/javascript'>alert('$message');
                         window.location.assign('students_4th_year.php')</script>"; 
                }
                else
                {
                    $sql = "INSERT into students(id,stud_id,stud_lastname,stud_firstname,stud_middlename,stud_department,stud_year,code_to_vote,stud_status,voting_status,stud_block_status) VALUES('','$st_id','$slname','$sfname','$smiddlename','$sdept','$syear','$scode','$stud_status','$v_status','$stud_blocked_status')";
                            ...
                            $message = "4th Year Student Successfully Added!";
                            echo "<script type='text/javascript'>alert('$message'); window.location.assign('students_4th_year.php')</script>";
                }
    }
                 ...
                 <ul class="nav">
                    ...
                    <li>
                        ...
                        <ul class="nav collapse list-unstyled" id="pagepeople">
                            ...
                            <li>
                                <a href="students_4th_year.php" style="color: white"><i class="fa fa-user" style="margin-top:-7px;color: yellow;"></i>4th Year</a>
                            </li>                                                
        ...
        <div class="main-panel">
            ...
            <div class="content">
                        ...
                        <div class="col" style="margin-top: -80px">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <form method="POST">
                                        <h3 class="title" style="font-family: Fjalla One"><b>4th Year Students</b><button class = "btn btn-info text-info" type='button' data-toggle="modal" data-target="#1styear-add-student" style="float: right;margin-left: 5px;margin-top: 17px;" ><i class="fa fa-user-plus fa-10x"></i></button><a href="students_4th_year.php" class = "btn btn-info text-info" type='button' style="float: right;margin-top: 17px;" ><i class="fa fa-refresh fa-10x"></i></a></h3>
                                    </form>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total No: <b><a href="list_of_total_voters_4thyear.php"><text id="total4thyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                              
                                    </div>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total number of Successful Voters: <b><a href="list_of_finish_voters_4thyear.php"><text id="successfulVoters4thyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                              
                                    </div>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Remaining number of voters: <b><a href="list_of_remaining_voters_4thyear.php"><text id="remainingVoters4thyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                    ...
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Block voters: <b><a href="list_of_block_voters_4thyear.php"><text id="blockvoters4thyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                ...
                <?php
                        ...
                        $sql = mysqli_query($link,"SELECT * FROM students where stud_year = '4th Year' ORDER BY stud_department,stud_lastname ASC");
                     ...
                     <div class="modal-body">
                        <p class="sub-text" style="margin-top: -20px"><text class="text-danger">Note: Make sure to review all fields.</text></p>
                         <form class="form-signin" method="POST">
                                ...
                                <button class="btn btn-success btn-lg btn-block mb-4 mt-4" type="submit" name = "submit-new-student-4th-year" style="color:white;font-family: 'Fjalla One', cursive;font-size: 20px">Add Student</button>
                            </form>
                     </div>
                        <div class="modal-footer">
   ...
   <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#total4thyear").load('totalno4thyearstudents.php')
          }, 200);
        });
    </script>
    ...
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#successfulVoters4thyear").load('getSuccessVoters4thyear.php')
          }, 200);
        });
    </script>
    ...
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#remainingVoters4thyear").load('getRemainingVoters4thyear.php')
          }, 200);
        });
    </script>
    ...
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#blockvoters4thyear").load('getblockVoters4thyear.php')
          }, 200);
        });
    </script>
