...
<body>
    ...
    -->
        ...
        <div class="main-panel">
            <nav class="navbar navbar-transparent navbar-absolute" style="margin-top: -20px;color: white">
                        ...
                        <div class="col"  style="margin-top: -80px">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <form method="POST">
                                        <h2 class="title"><b>Options</b> <button class = "btn btn-info text-info" type='button' data-toggle="modal" data-target="#exampleModal1990" style="float: right">Option</button></h2>
                                    </form>
                                </div>
                                <div class="card-content">
                                    <h5> Remaining Students to vote: </h5>
                                    <h6>Grade 11: </h6>
...
<script src="vendor/datatables/jquery.dataTables.js"></script>
   ...
   <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#dbpendingstats").load('getDataCount.php')
          }, 200);
        });

      //$(document).ready(function(){
        // setInterval(function(){
         //  $("#dbtotalleavestats").load('dean_totalleavescount.php')
       // }, 200);
      // });
    </script>
