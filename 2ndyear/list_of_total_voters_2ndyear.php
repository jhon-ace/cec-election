...
<head>
    ...
    <title>2nd Year | List of Voters</title>
                        ...
                        <div class="col" style="margin-top: -80px">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <form method="POST">
                                        <h3 class="title" style="font-family: Fjalla One"><b>List of Voters - 2ND Year</b><a href="list_of_total_voters_2ndyear.php" class = "btn btn-info text-info" type='button' style="float: right;margin-top: 17px;margin-left: 5px" ><i class="fa fa-refresh"></i></a><a href="students_2nd_year.php" class = "btn btn-info text-info" type='button' style="float: right;margin-top: 17px;" ><i class="fa fa-arrow-left fa-10x"></i> Back</a></h3>
                                    </form>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total Number: <b><a href=""><text id="total2ndyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>    
                                    </div>
                                    <div class="col">
                                         <b><a href="../fpdf/studentlistpdf_students2ndyear.php" target="_blank"><i class="fa fa-print"></i> <text  style="text-decoration: underline;">&nbsp;Print List</text></a></b>    
                                    </div>
                                </div>
