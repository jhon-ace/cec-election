...
<?php
    ...
    if(isset($_POST['submit-new-student-2nd-year']))
    {
                ...
                if (mysqli_num_rows($res_u) > 0) 
                {
                    $message = "Student ID Exist";
                        echo "<script type='text/javascript'>alert('$message');
                         window.location.assign('students_2nd_year.php')</script>"; 
                }
                else
                {
                    $sql = "INSERT into students(id,stud_id,stud_lastname,stud_firstname,stud_middlename,stud_department,stud_year,code_to_vote,stud_status,voting_status,stud_block_status) VALUES('','$st_id','$slname','$sfname','$smiddlename','$sdept','$syear','$scode','$stud_status','$v_status','$stud_blocked_status')";
                            ...
                            $message = "2nd Year Student Successfully Added!";
                            echo "<script type='text/javascript'>alert('$message'); window.location.assign('students_2nd_year.php')</script>";
                }
    }
                 ...
                 <ul class="nav">
                    ...
                    <li>
                        ...
                        <ul class="nav collapse list-unstyled" id="pagepeople">
                            ...
                            <li>
                                <a href="students_2nd_year.php" style="color: white"><i class="fa fa-user" style="margin-top:-7px;color: yellow;"></i>2nd Year</a>
                            </li>
                            <li>
        ...
        <div class="main-panel">
            ...
            <div class="content">
                        ...
                        <div class="col" style="margin-top: -80px">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <form method="POST">
                                        <h3 class="title" style="font-family: Fjalla One"><b>2nd Year Students</b><button class = "btn btn-info text-info" type='button' data-toggle="modal" data-target="#1styear-add-student" style="float: right;margin-left: 5px;margin-top: 17px;" ><i class="fa fa-user-plus fa-10x"></i></button><a href="students_2nd_year.php" class = "btn btn-info text-info" type='button' style="float: right;margin-top: 17px;" ><i class="fa fa-refresh fa-10x"></i></a></h3>
                                    </form>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total No: <b><a href="list_of_total_voters_2ndyear.php"><text id="total2ndyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                              
                                    </div>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total number of Successful Voters: <b><a href="list_of_finish_voters_2ndyear.php"><text id="successfulVoters2ndyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                              
                                    </div>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Remaining number of voters: <b><a href="list_of_remaining_voters_2ndyear.php"><text id="remainingVoters2ndyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                    ...
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Block voters: <b><a href="list_of_block_voters_2ndyear.php"><text id="blockvoters2ndyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                ...
                <?php
                        ...
                        $sql = mysqli_query($link,"SELECT * FROM students where stud_year = '2nd Year' ORDER BY stud_department,stud_lastname ASC");
    ...
    <form method="post">
        <div class="modal fade" id="1styear-add-student" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"   aria-hidden="true" style="margin-top: -70px">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add 2ND YEAR Student</h5>
                     ...
                     <div class="modal-body">
                        <p class="sub-text" style="margin-top: -20px"><text class="text-danger">Note: Make sure to review all fields.</text></p>
                         <form class="form-signin" method="POST">
                                ...
                                <button class="btn btn-success btn-lg btn-block mb-4 mt-4" type="submit" name = "submit-new-student-2nd-year" style="color:white;font-family: 'Fjalla One', cursive;font-size: 20px">Add Student</button>
                            </form>
                     </div>
                        <div class="modal-footer">
   ...
   <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#total2ndyear").load('totalno2ndyearstudents.php')
          }, 200);
        });
    </script>
    ...
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#successfulVoters2ndyear").load('getSuccessVoters2ndyear.php')
          }, 200);
        });
    </script>
    ...
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#remainingVoters2ndyear").load('getRemainingVoters2ndyear.php')
          }, 200);
        });
    </script>
    ...
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#blockvoters2ndyear").load('getblockVoters2ndyear.php')
          }, 200);
        });
    </script>
