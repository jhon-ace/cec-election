...
<head>
    ...
    <title>2nd Year | Successful Voters</title>
                    ...
                    <li>
                        ...
                        <ul class="nav collapse list-unstyled" id="pagepeople">
                            <li style="color:black"  class="active">
                                <a href="../grade11/students_1st_year.php" style="color: white"><i class="fa fa-user" style="margin-top:-7px"></i>Grade 11</a>
                            </li>
                            <li>
        ...
        <div class="main-panel">
            ...
            <div class="content">
                        ...
                        <div class="col" style="margin-top: -80px">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <form method="POST">
                                        <h3 class="title" style="font-family: Fjalla One"><b>List of Successful Voters - 2nd Year</b><a href="list_of_finish_voters_2ndyear.php" class = "btn btn-info text-info" type='button' style="float: right;margin-top: 17px;margin-left: 5px" ><i class="fa fa-refresh"></i></a><a href="students_2nd_year.php" class = "btn btn-info text-info" type='button' style="float: right;margin-top: 17px;" ><i class="fa fa-arrow-left fa-10x"></i> Back</a></h3>
                                    </form>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total Number: <b><a href=""><text id="successfulVoters2ndyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>    
                                    </div>
                                    <div class="col">
                                         <b><a href="../fpdf/finishvotinglistpdf_students2ndyear.php" target="_blank"><i class="fa fa-print"></i> <text  style="text-decoration: underline;">&nbsp;Print List</text></a></b>    
                                    </div>
                                </div>
                ...
                <?php
                        ...
                        $sql = mysqli_query($link,"SELECT * FROM students where voting_status = 'finished voting' AND stud_block_status = 'none' AND stud_status = '1' AND stud_year = '2nd Year' ORDER BY stud_department,stud_lastname ASC");
