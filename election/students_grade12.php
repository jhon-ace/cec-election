                    ...
                    <li>
                        ...
                        <ul class="nav collapse list-unstyled" id="pagepeople">
                            ...
                            <li  style="color:black" class="active">
                                <a href="students_grade12.php" style="color: white"><i class="fa fa-user" style="margin-top:-7px;color: yellow;"></i>Grade 12</a>
                            </li>
                            <li>
        ...
        <div class="main-panel">
            ...
            <div class="content">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <form method="POST">
                                        <h2 class="title"><b>Grade <text class="text-danger">12</text> Students</b> <button class = "btn btn-info" type='button' data-toggle="modal" data-target="#exampleModal1990" style="float: right">Add Student</button></h2>
                                    </form>
                                </div>
                ...
                <?php
                        ...
                        $sql = mysqli_query($link,"SELECT * FROM students where stud_year = 'Grade - 12' ORDER BY stud_id DESC");
                    ...
                    <div class="modal-header">
                     ...
                     <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="modal fade" id="login-error" tabindex="-1" role="document" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                      ...
                      <div class="modal-body">
                        fbvdfc<?php if(isset($script)){ echo $script; } ?>
                      </div>
                      <div class="modal-footer">
