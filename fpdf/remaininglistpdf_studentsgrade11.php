...
class myPDF extends FPDF{
		...
		$this->Cell(77,5,'GRADE - 11 | LIST OF REMAINING VOTERS',0,0,'R');
	...
	function viewTable($db){
		...
		$link = mysqli_connect('localhost','root','19976112','election');
		$sql = mysqli_query($link,"SELECT * FROM students where voting_status = 'ready to vote' AND stud_block_status = 'unblock' AND stud_year = 'G - 11' AND stud_status = '0' ORDER BY stud_department,stud_lastname ASC");
...
date_default_timezone_set('Asia/Manila');
//$datekaron = date('l, F j, Y');
$pdf->Output('I','Grade - 11 | Remaining Voters.pdf','I');
