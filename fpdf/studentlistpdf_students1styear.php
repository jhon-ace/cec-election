...
class myPDF extends FPDF{
		...
		function header_display($db){
                    ...
                    $vot = "finish voting";
                    $sql2 = mysqli_query($link, "SELECT COUNT(*) 'TOTAL' FROM students where stud_year = '1st Year'");
		...
		$this->Cell(53,5,'1ST YEAR | LIST OF VOTERS',0,0,'R');
...
date_default_timezone_set('Asia/Manila');
//$datekaron = date('l, F j, Y');
$pdf->Output('I','1st Year | List of Final Voters.pdf','I');
