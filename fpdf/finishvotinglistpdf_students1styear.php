...
class myPDF extends FPDF{
		...
		function header_display($db){
                    ...
                    $vot = "finished voting";
                    $sql2 = mysqli_query($link, "SELECT COUNT(*) 'TOTAL' FROM students WHERE voting_status = '$vot' and stud_year = '1st Year' AND stud_block_status = 'none' AND stud_status = '1'");
		...
		$this->Cell(76,5,'1ST YEAR | LIST OF SUCCESSFUL VOTERS',0,0,'R');
...
date_default_timezone_set('Asia/Manila');
//$datekaron = date('l, F j, Y');
$pdf->Output('I','1st Year | Successful Voters.pdf','I');
