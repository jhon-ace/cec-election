...
class myPDF extends FPDF{
		...
		function header_display($db){
                    ...
                    $vot = "finish voting";
                    $sql2 = mysqli_query($link, "SELECT COUNT(*) 'TOTAL' FROM students where stud_year = 'G - 12' AND stud_block_status = 'block' and voting_status = 'unable to vote'");
		...
		$this->Cell(69,5,'GRADE - 12 | LIST OF BLOCK VOTERS',0,0,'R');
	...
	function viewTable($db){
		...
		$link = mysqli_connect('localhost','root','19976112','election');
		$sql = mysqli_query($link,"SELECT * FROM students where stud_year = 'G - 12' AND stud_block_status = 'block' and voting_status = 'unable to vote' ORDER BY stud_department,stud_lastname ASC");
...
date_default_timezone_set('Asia/Manila');
//$datekaron = date('l, F j, Y');
$pdf->Output('I','Grade - 12 | List of block voters.pdf','I');
