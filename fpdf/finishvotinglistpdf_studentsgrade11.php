...
class myPDF extends FPDF{
		...
		function header_display($db){
                    ...
                    $vot = "finished voting";
                    $sql2 = mysqli_query($link, "SELECT COUNT(*) 'TOTAL' FROM students WHERE voting_status = '$vot' and stud_year = 'G - 11' AND stud_block_status = 'none' AND stud_status = '1'");
		...
		$this->Cell(81,5,'GRADE - 11 | LIST OF SUCCESSFUL VOTERS',0,0,'R');
	...
	function viewTable($db){
		...
		$link = mysqli_connect('localhost','root','19976112','election');
		$sql = mysqli_query($link,"SELECT * FROM students where voting_status = 'finished voting' AND stud_block_status = 'none' AND stud_status = '1' AND stud_year = 'G - 11' ORDER BY stud_department,stud_lastname ASC");
...
date_default_timezone_set('Asia/Manila');
//$datekaron = date('l, F j, Y');
$pdf->Output('I','Grade - 11 | Successful Voters.pdf','I');
