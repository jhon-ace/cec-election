...
class myPDF extends FPDF{
		...
		$this->Cell(56,5,'GRADE - 11 | LIST OF VOTERS',0,0,'R');
	...
	function viewTable($db){
		...
		$link = mysqli_connect('localhost','root','19976112','election');
		$sql = mysqli_query($link,"SELECT * FROM students where stud_year = 'G - 11' ORDER BY stud_department,stud_lastname ASC");
...
date_default_timezone_set('Asia/Manila');
//$datekaron = date('l, F j, Y');
$pdf->Output('I','Grade - 11 | List of Final Voters.pdf','I');
