...
<?php
    ...
    if(isset($_POST['submit-new-student-3rd-year']))
    {

                $st_id = $_POST['add_stud`ent_id`'];
                ...
                if (mysqli_num_rows($res_u) > 0) 
                {
                    $message = "Student ID Exist";
                        echo "<script type='text/javascript'>alert('$message');
                         window.location.assign('students_3rd_year.php')</script>"; 
                }
                else
                {
                 ...
                 <ul class="nav">
                    ...
                    <li>
                        ...
                        <ul class="nav collapse list-unstyled" id="pagepeople">
                            ...
                            <li>
                                <a href="students_3rd_year.php" style="color: white"><i class="fa fa-user" style="margin-top:-7px;color: yellow;"></i>3rd Year</a>
                            </li>
                            <li>
        ...
        <div class="main-panel">
            ...
            <div class="content">
                        ...
                        <div class="col" style="margin-top: -80px">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <form method="POST">
                                        <h3 class="title" style="font-family: Fjalla One"><b>3rd Year Students</b><button class = "btn btn-info text-info" type='button' data-toggle="modal" data-target="#1styear-add-student" style="float: right;margin-left: 5px;margin-top: 17px;" ><i class="fa fa-user-plus fa-10x"></i></button><a href="students_3rd_year.php" class = "btn btn-info text-info" type='button' style="float: right;margin-top: 17px;" ><i class="fa fa-refresh fa-10x"></i></a></h3>
                                    </form>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total No: <b><a href="list_of_total_voters_3rdyear.php"><text id="total3rdyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                              
                                    </div>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total number of Successful Voters: <b><a href="list_of_finish_voters_3rdyear.php"><text id="successfulVoters3rdyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                              
                                    </div>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Remaining number of voters: <b><a href="list_of_remaining_voters_3rdyear.php"><text id="remainingVoters3rdyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                    ...
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Block voters: <b><a href="list_of_block_voters_3rdyear.php"><text id="blockvoters3rdyear" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                ...
                <?php
                        ...
                        $sql = mysqli_query($link,"SELECT * FROM students where stud_year = '3rd Year' ORDER BY stud_department,stud_lastname ASC");
    ...
    <form method="post">
        <div class="modal fade" id="1styear-add-student" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"   aria-hidden="true" style="margin-top: -70px">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add 3RD YEAR Student</h5>
                     ...
                     <div class="modal-body">
                        <p class="sub-text" style="margin-top: -20px"><text class="text-danger">Note: Make sure to review all fields.</text></p>
                         <form class="form-signin" method="POST">
                                ...
                                <button class="btn btn-success btn-lg btn-block mb-4 mt-4" type="submit" name = "submit-new-student-3rd-year" style="color:white;font-family: 'Fjalla One', cursive;font-size: 20px">Add Student</button>
                            </form>
                     </div>
                        <div class="modal-footer">
   ...
   <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#total3rdyear").load('totalno3rdyearstudents.php')
          }, 200);
        });
    </script>
    ...
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#successfulVoters3rdyear").load('getSuccessVoters3rdyear.php')
          }, 200);
        });
    </script>
    ...
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#remainingVoters3rdyear").load('getRemainingVoters3rdyear.php')
          }, 200);
        });
    </script>
    ...
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#blockvoters3rdyear").load('getblockVoters3rdyear.php')
          }, 200);
        });
    </script>
