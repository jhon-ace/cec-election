...
(1, '201910148', 'G - 12', 'Balani, Cyrus Jay - MEGA', 'Lapure, Rucel - TAYO', 'G - 12'),
(2, '201910222', 'G - 12', 'Esto, Wendy Mae - TAYO', 'Tadle, Jeanne - ACT', 'G - 12');
...
--
ALTER TABLE `governors`
  MODIFY `gov_vice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
