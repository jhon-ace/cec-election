...
<?php
    ...
    if(isset($_POST['submit-new-student-grade12']))
    {
                ...
                if (mysqli_num_rows($res_u) > 0) 
                {
                    $message = "Student ID Exist";
                        echo "<script type='text/javascript'>alert('$message');
                         window.location.assign('students_grade12.php')</script>"; 
                }
                else
                {
                    $sql = "INSERT into students(id,stud_id,stud_lastname,stud_firstname,stud_middlename,stud_department,stud_year,code_to_vote,stud_status,voting_status,stud_block_status) VALUES('','$st_id','$slname','$sfname','$smiddlename','$sdept','$syear','$scode','$stud_status','$v_status','$stud_blocked_status')";
                            ...
                            $message = "Grade 12 Student Successfully Added!";
                            echo "<script type='text/javascript'>alert('$message'); window.location.assign('students_grade12.php')</script>";
                }
    }
    
    if(isset($_POST['update-student-grade12']))
    {
                $id_iTF = $_POST['idIF'];
...
<body>
                 ...
                 <ul class="nav">
                    ...
                    <li>
                        ...
                        <ul class="nav collapse list-unstyled" id="pagepeople">
                            ...
                            <li>
                                <a href="../grade12/students_grade12.php" style="color: white"><i class="fa fa-user" style="margin-top:-7px;color: yellow;"></i>Grade 12</a>
                            </li>
                            <li>
                        ...
                        <div class="col" style="margin-top: -80px">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <form method="POST">
                                        <h3 class="title" style="font-family: Fjalla One"><b>Grade 12 Students</b><button class = "btn btn-info text-info" type='button' data-toggle="modal" data-target="#add_student_grade11" style="float: right;margin-left: 5px;margin-top: 17px;" ><i class="fa fa-user-plus fa-10x"></i></button><a href="students_grade12.php" class = "btn btn-info text-info" type='button' style="float: right;margin-top: 17px;" ><i class="fa fa-refresh fa-10x"></i></a></h3>
                                    </form>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total No: <b><a href="list_of_total_voters_grade12.php"><text id="totalgrade12" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                              
                                    </div>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Total number of Successful Voters: <b><a href="list_of_finish_voters_grade12.php"><text id="successfulVotersgrade12" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                              
                                    </div>
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Remaining number of voters: <b><a href="list_of_remaining_voters_grade12.php"><text id="remainingVotersgrade12" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
                                    ...
                                    <div class="col">
                                        <p style="color: white;font-family: consolas">Block voters: <b><a href="list_of_block_voters_grade12.php"><text id="blockvotersgrade12" style="color:yellow;font-size: 20px">
                                                &nbsp;
                                              </text></a></b></p>
   ...
   <!--####################################    ADD STUDENT  #################################################################-->
    <form method="post">
        <div class="modal fade" id="add_student_grade11" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"   aria-hidden="true" style="margin-top: -70px">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add Grade - 12 Student</h5>
                     ...
                     <div class="modal-body">
                        <p class="sub-text" style="margin-top: -20px"><text class="text-danger">Note: Make sure to review all fields.</text></p>
                         <form class="form-signin" method="POST">
                                ...
                                <div class="form-label-group">
                                 ...
                                 <div class="form-label-group">
                                        <select class="form-control text-danger" name="stud_department" disabled="">
                                            <option value="Grade - 12"  selected="">SR. HIGH</option>
                                ...
                                <div class="form-label-group">
                                    <input type="text" name="stud_voting_code#" class="form-control" required placeholder="e.g: 3rw2">
                                        <label for="inputEmail" style="color:black;font-family: 'Livvic', sans-serif;">Voting Code #:</label>
                                </div>

                                <button class="btn btn-success btn-lg btn-block mb-4 mt-4" type="submit" name = "submit-new-student-grade12" style="color:white;font-family: 'Fjalla One', cursive;font-size: 20px">Add Student</button>
                            </form>
                     </div>
                        <div class="modal-footer">
                ...
                <div class="modal-content">
                    ...
                    <p class="sub-text" style="margin-top: -20px"><text class="text-danger">Note: Make sure to review all fields.</text></p>
                         <form class="form-signin" method="POST">
                                ...
                                <button class="btn btn-success btn-lg btn-block mb-4 mt-4" type="submit" name = "update-student-grade12" style="color:white;font-family: 'Fjalla One', cursive;font-size: 20px">Save Changes</button>
                            </form>
                     </div>
                        <div class="modal-footer">
...
<script src="../assets/js/demo.js"></script>
    ...
    <script>
      ...
      <!-- get total no of grade 12 students  -->
   <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#totalgrade12").load('totalnograde12students.php')
          }, 200);
        });
    </script>

      <!-- get total no of grade 12 successful voters  -->
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#successfulVotersgrade12").load('getSuccessVotersgrade12.php')
          }, 200);
        });
    </script>

      <!-- get total no of remaining  voters - grade 12 students  -->
    <script>
      $(document).ready(function(){
          setInterval(function(){
            $("#remainingVotersgrade12").load('getRemainingVotersgrade12.php')
          }, 200);
        });
    </script>

      <!-- get total no of  block student - grade 12 students  -->
    <script>
      $(document).ready(function(){
          setInterval(function(){
